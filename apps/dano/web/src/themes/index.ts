...
export function resolveAppThemeVars(
  ...
  return {
    ...
    "--center-column-bg": mode === "dark" ? base16.base00 : "#f9f9f9",
    "--composer-dock-bg": mode === "dark" ? "#212121" : base30.one_bg,
    "--send-button-bg": mode === "dark" ? "#48a04c" : "#53b559",
    "--user-message-bg": mode === "dark" ? "#2c6732" : "#def3e5",
