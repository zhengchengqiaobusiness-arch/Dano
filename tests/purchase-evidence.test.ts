...
function purchaseEvents(): EvidenceEvent[] {
  return [{
    ...
    request: {
      method: "GET",
      url: "http://admin.dianshixinxi.com:90/admin-api/erp/purchase/order/page?no=CGDD&productId=3&status=10&pageNo=1&pageSize=10",
      resourceType: "xhr", headers: {}, query: { no: "CGDD", productId: 3, status: 10, pageNo: 1, pageSize: 10 }
    },
    response: { status: 200, headers: {}, body: { success: true, data: { list: [], total: 0 } } }
  }, {
