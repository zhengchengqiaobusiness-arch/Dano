...
class Settings(BaseSettings):
    ...
    pi_api_key: str = "sk-8f0a70ee5dcf4e0580e3c9e091dc116b"                                   # = DANO_PI_API_KEY(编码 + 评审复用)
    pi_base_url: str = "https://api.deepseek.com/v1"     # = DANO_PI_BASE_URL
    pi_model: str = "deepseek-v4-flash"            # = DANO_PI_MODEL(PiCoder 编码用)

    # ── 三模型评审委员会(发布前硬闸门;3 个角色都过即可,模型可相同;改模型名即可)──
    review_enabled: bool = True
    review_model_acceptance: str = "deepseek-v4-flash"   # 成果验收:是否真满足业务意图
    review_model_security: str = "deepseek-v4-flash"            # 漏洞检测:注入/越权/密钥/SSRF/PII
    review_model_compliance: str = "deepseek-v4-flash"     # 合规审核:沙箱/测试凭证/风险/确认
