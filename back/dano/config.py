...
class Settings(BaseSettings):
    ...
    pi_base_url: str = "https://api.kunkunout.cn/v1"     # = DANO_PI_BASE_URL(非密钥,可 .env 覆盖)
    pi_model: str = "claude-opus-4-8"            # = DANO_PI_MODEL(评审/分类的 OpenAI 兼容模型)
    ...
    review_model_security: str = "claude-opus-4-8"            # 漏洞检测:注入/越权/密钥/SSRF/PII
    review_model_compliance: str = "claude-opus-4-8"     # 合规审核:沙箱/测试凭证/风险/确认
