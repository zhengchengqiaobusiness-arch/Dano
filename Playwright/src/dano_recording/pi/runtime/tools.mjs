...
const semanticOperation = Type.Object({
  op: Type.Union([
    ...
    Type.Literal("set_flow_goal"), Type.Literal("set_flow_action"),
    Type.Literal("set_business_description"), Type.Literal("set_step_name"),
    Type.Literal("set_step_title"), Type.Literal("set_capability_name"),
    Type.Literal("set_capability_title"), Type.Literal("set_capability_description"),
  ]),
