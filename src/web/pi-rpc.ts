  ...
  async start() {
    ...
    args.push(
      ...
      [
        ...
        "snapshot.formFields/todoFields are the visible field checklist for the active page or dialog. 「请选择」and a required number 0 are empty. When the user requires every field filled except upload, call exercise-form then submit-form. Do not skip optional or blank fields. If a planned write submit fails validation, repair the form and submit again; do not stop or export without a successful write response.",
